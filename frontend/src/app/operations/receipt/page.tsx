...
export default function ReceiptPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const res = await fetch("http://127.0.0.1:8001/operations/receipt", {
                method: "POST",
                headers: {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-green-50">
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-2xl font-bold text-green-800">Receipt Created!</h2>
                    ...
                    <CardContent className="p-6">
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-gray-700">Received From (Party)</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-gray-700">Deposit To</label>
                                <select
                                    className="w-full p-2 border rounded-md focus:ring-2 focus:ring-blue-500 outline-none"
